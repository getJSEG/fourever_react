    ...
    return(
        <div className="setting-continer"> 
            ...
            <div className="window-containers">
                ...
                <div className="setting-menu">
...

                    {
                       ((userRoles?.includes("Manager") || userRoles?.includes("Owner")) && !isSuperUser) &&
                        <span className="li-menu-container"> 
                            <div className="menu-links-container pointer" onClick={() =>  itemClickedHandler("transactionhistory") }> 
                                <svg xmlns="http://www.w3.org/2000/svg" width="50" height="50" fill="currentColor" className="bi bi-receipt" viewBox="0 0 20 20">
                ...
                { itemClicked === "transactionhistory" && <TransactionHistory />}
            </div>
